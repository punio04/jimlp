...
$site_top = "http://examplee-com.check-xserver.jp/jim/index.html";

//管理者のメールアドレス ※メールを受け取るメールアドレス(複数指定する場合は「,」で区切ってください 例 $to = "aa@aa.aa,bb@bb.bb";)
$to = "santedasuke@gmail.com";
...
$thanksPage = "http://examplee-com.check-xserver.jp/jim/thanks.html";
...
$require = array('お名前', 'Email', 'Email確認');
...
──────────────────────
株式会社パーソナルトレーニングジムSANTE　佐藤太郎
〒410-0053 静岡県沼津市寿町26-24 メルヴェール 101
営業時間：平日9:00～23:00　日曜日 9:00～19:00 【完全予約制】
定休日：土曜日
E-mail:xxxx@xxxx.com
URL: http://examplee-com.check-xserver.jp/jim/index.html
──────────────────────
...
?>
	...
	<body>
		...
		<div id="formWrap">
			...
			<?php } else { ?>
				<h3 style="text-align: center;font-size: 25px;margin: 40px;">確認画面</h3>
...
<?php
		...
		function copyright()
		{
			echo '<a style="display:block;text-align:center;margin:15px 0;font-size:11px;color:#aaa;text-decoration:none" href="http://examplee-com.check-xserver.jp/jim/index.html" target="_blank">- Copyright 2023 パーソナルジムSANTE -</a>';
		}
		//----------------------------------------------------------------------
		//  関数定義(END)
		//----------------------------------------------------------------------
